...
function generateDailyChallenge() {
  ...
  const allModes = [
    ...
    { mode: 'scan', levels: [16, 25, 36, 49], titles: ['4×4 闪电扫视', '5×5 闪电扫视', '6×6 闪电扫视', '7×7 闪电扫视'], targets: ['12秒内完成', '15秒内完成', '20秒内完成', '28秒内完成'] },
    ...
    { mode: 'sort', levels: [9, 16, 25, 36], titles: ['3×3 序列排序', '4×4 序列排序', '5×5 序列排序', '6×6 序列排序'], targets: ['20秒内完成', '40秒内完成', '60秒内完成', '100秒内完成'] },
